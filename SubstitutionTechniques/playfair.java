...
public class playfair {
    ...
    public String Encript(String Source) {
        ...
        for (int i = 0; i < src_arr.length; i++) {
            ...
            System.out.println("Encript: part1 " + part1[0] + part1[1]);
            System.out.println("Encript: part2 " + part2[0] + part2[1]);
            if (part1[0] == part2[0]) {
                if (part1[1] < 4)
                    part1[1]++;
                else
        ...
        System.out.println("Encrypted Text is->" + Code);
        return Code;
    }
    ...
    public String Decript(String Code) {
        ...
        System.out.println("Decrypted Text is->" + Original);
        return Original;
    ...
    public static void main(String[] args) {
        ...
        if (choosen_value == 1) {
            ...
            System.out.println("Make Sure the length of message is even");
            String key_input = sc.next();
            String Encripted = x.Encript(key_input);
            x.Decript(Encripted);
        }
